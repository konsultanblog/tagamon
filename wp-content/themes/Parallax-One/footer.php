    ...
    <footer itemscope itemtype="http://schema.org/WPFooter" id="footer" role="contentinfo" class = "footer grey-bg">
        ...
        <div class="container">
	        ...
	        <div class="powered-by">
	            Supported by: <a class="" href="http://www.konsultanblog.com/" target="_blank" rel="nofollow">KonsultanBlog.com </a> 
<!-- <?php //esc_html_e('powered by','parallax-one'); ?> <a class="" href="http://wordpress.org/" target="_blank" rel="nofollow"><?php //esc_html_e('WordPress','parallax-one'); ?></a> -->
	        </div>
