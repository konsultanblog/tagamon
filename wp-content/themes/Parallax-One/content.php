	...
	<header class="entry-header">
			...
			<div class="entry-meta list-post-entry-meta">
				<span itemscope itemprop="author" itemtype="http://schema.org/Person" class="entry-author post-author">
					...
					<i class="icon-man-people-streamline-user"></i><a itemprop="url" class="url fn n" href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' )); ?>" rel="author"><?php get_the_author_meta('user_nicename')!=''?get_the_author_meta('user_nicename'):the_author(); ?> </a>
					</span>
				</span>
